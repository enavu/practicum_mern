...
this.handleSelectChange = this.handleSelectChange.bind(this);
      ...
      this.insertNewBusiness = this.insertNewBusiness.bind(this);
...
<div className='button-center'>
        <br/>
        <Button bsStyle="success" bsSize="small" onClick={this.onClick}>Add New Business</Button>
       </div>
          </Modal>
        </div>
      )
